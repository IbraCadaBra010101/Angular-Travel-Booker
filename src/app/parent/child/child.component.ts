...
export class ChildComponent implements OnInit {
  ...
  @Output() touristAttractionsEvent = new EventEmitter<any>();
  @Output() sendResetToParentEvent = new EventEmitter<any>();
  @Input() acceptingReset: any;

  cities = [{
    name: 'Rom', continent: 'Europa',
    ...
    name: 'Mexico-City', continent: 'Central-Amerika',
  ...
  showDefault() {
    ...
    this.romeClicked = false;
    this.athensClicked = false;
    this.berlinClicked = false;
    this.mexicoCityClicked = false;
    this.acceptingReset = false;
    this.citiesEvent.emit(this.acceptingReset);
    console.log(this.acceptingReset + ' in child');
  }

  showRome(event: Event) {
    this.resetClicked = false;
    this.romeClicked = true;
    this.athensClicked = false;
    this.berlinClicked = false;
    this.mexicoCityClicked = false;
